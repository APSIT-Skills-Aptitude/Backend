...
create procedure Reg(IN UEmail varchar(50), IN pass varchar(50), IN Uname varchar(50), IN UNo int(15), IN Uadd longtext, IN city varchar(15), IN ctry varchar(25), IN post int(10), IN inst varchar(100), IN photo varchar(325), IN verificationCode varchar(21))
BEGIN
...
create procedure addCOMP(IN ac int, IN cname varchar(50), IN descrip varchar(200), IN logo varchar(325))
BEGIN
...
create procedure addQuiz(IN Qname varchar(100), IN CompID int, IN quizTime int, IN is_active tinyint(1))
BEGIN
set @table:=Qname;
...
create procedure fetchQuiz(IN entryId int, IN quizId varchar(500))
BEGIN
    set @active := false;
