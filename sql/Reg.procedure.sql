create definer = u800182220_disha@`%` procedure Reg(IN UEmail varchar(50), IN pass varchar(50), IN Uname varchar(50), IN UNo int(15), IN Uadd longtext, IN city varchar(15), IN ctry varchar(25), IN post int(10), IN inst varchar(100), IN photo varchar(325), IN verificationCode varchar(21))
BEGIN
